...
// var index bevat de functie noFinischedEventYet(Events).
    request.execute(function(resp) {
        ...
        if (events.length > 0) {
            ...
            var zintwee = document.getElementById('passende-zintwee');
            zintwee.innerHTML = "Geen evenementen";
        }
    });
}
...
function futureSentence(event) {
	  var zintwee = document.getElementById('passende-zintwee');
     zintwee.innerHTML = "We zien dat je straks " + event.summary + " gaat doen, wil je jouw ervaring met ons delen?";
 };
...
function pastSentence(event) {
    var zintwee = document.getElementById('passende-zintwee');
    zintwee.innerHTML = "We zien dat je " + event.summary + " hebt gedaan, wil je jouw ervaring met ons delen?";
 };
