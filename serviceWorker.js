...
self.addEventListener('push', function(event) {
  ...
  var title = 'Een nieuwe vraag van de dag!';
  var body = {
    'body': 'Klik hier om terug naar de applicatie te gaan',
    'tag': '',
    'icon': './images/icons/apple-icon-144x144.png',
    'badge': './images/icons/apple-icon-144x144.png',
    //Custom actions buttons
    'actions': [
      { "action": "yes", "title": "Beantwoord de nieuwe vraag"}
    ]
  };
